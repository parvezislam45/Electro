...
const Feature = () => {
  return (
    <div>
      <div className="container px-2 mx-auto grid gap-5 grid-cols-1 md:grid-cols-5 mt-4">
        <div className="col-span-4 mt-14">
          <ul className="items-stretch hidden space-x-36 lg:flex mx-10">
            <li className="">
              <a
                rel="noopener noreferrer"
                href="/"
                className="flex items-center border-b-2 border-yellow-500 text-black font-normal text-xl"
              >
                Featured Product
          ...
          <div className="container px-7 mx-auto grid gap-5 grid-cols-1 md:grid-cols-3 mt-14">
            <div className="card lg:card-side bg-base-100 -mt-14">
              <img
                src="https://electro.madrasthemes.com/wp-content/uploads/2016/03/redPhone-300x300.png"
                alt="Album"
                className="w-20 h-24 mt-7 mx-auto"
              />

              <div className="card-body mx-auto">
                <h2 className="text-sm font-bold text-sky-500">
                  Tablet Thin EliteBook
                  <br />
                  Revolve 810 G3
                </h2>
            ...
            <div className="card lg:card-side bg-base-100 -mt-14">
              <img
                ...
                alt="Album"
                className="w-16 h-28 mt-7 mx-auto"
              />
              ...
              <div className="card-body mx-auto">
                ...
                <div className="flex items-start justify-between mt-5">
                  <h2 className="text-lg font-normal">$ 99.00</h2>
                </div>
              </div>
            </div>
            <div className="card lg:card-side bg-base-100 -mt-14">
              ...
              <div className="card-body mx-auto">
                ...
                <div className="flex items-start justify-between">
                  <h2 className="text-lg font-normal text-red-600">
                    $ 1,999.00
                  </h2>
                  <h2 className="text-sm line-through font-normal mt-1">
                    $ 2,299.00
                  </h2>
                </div>
              </div>
            ...
            <div className="card lg:card-side bg-base-100 -mt-14">
              ...
              <div className="card-body mx-auto">
                ...
                <div className="flex items-start justify-between">
                  <h2 className="text-lg font-normal">$ 1,100.00</h2>
                </div>
              </div>
            </div>
            <div className="card lg:card-side bg-base-100 -mt-14">
            ...
            <div className="card lg:card-side bg-base-100 -mt-14">
              ...
              <div className="card-body mx-auto">
                ...
                <div className="flex items-start justify-between mt-7">
                  <h2 className="text-lg font-normal text-red-600">$ 750.00</h2>
                  <h2 className="text-sm line-through font-normal mt-1">
                    $ 780.00
                  </h2>
                </div>
